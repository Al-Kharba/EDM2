## EDM-2: Unofficial implementation based on the official [code](https://github.com/NVlabs/edm) of the first version
...
<br>https://arxiv.org/abs/2312.02696<br>

Key Contributions:
<br>
- [x] Config B: minor improvements
- [x] Config C: architectural streamlining
- [x] Config D: magnitude-preserving learned layers
- [x] Config E: control effective learning rate
- [x] Config F: remove group normalizations
- [x] Config G: magnitude-preserving fixed-functions layers
- [ ] Post-hoc EMA
